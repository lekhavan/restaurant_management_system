...
import com.vangcc19135.RestaurantManagementSystem.databinding.ActivityOrderBinding;
...
public class OrderActivity extends AppCompatActivity {
    ...
    private void initData() {
        try {
            ...
            binding.tvTotalMoney.setText(formatter.format(bill.getTotalMoney()) + "VND");
