package com.vangcc19135.restaurantManagementSystem.UserExperience.statistic;
...
import com.vangcc19135.RestaurantManagementSystem.databinding.FragmentNotificationsBinding;
...
//                    Toast.makeText(SpinnerActivity.this, "onNothingSelected", Toast.LENGTH_SHORT).show();
    ...
    private void initMonth() {
        ...
        barTitleArrayList.add("M1");
        barTitleArrayList.add("M2");
        barTitleArrayList.add("M3");
        barTitleArrayList.add("M4");
        barTitleArrayList.add("M5");
        barTitleArrayList.add("M6");
        barTitleArrayList.add("M7");
        barTitleArrayList.add("M8");
        barTitleArrayList.add("M9");
        barTitleArrayList.add("M10");
        barTitleArrayList.add("M11");
        barTitleArrayList.add("M12");
    }
