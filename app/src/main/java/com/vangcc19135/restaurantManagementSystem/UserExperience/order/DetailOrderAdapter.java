package com.vangcc19135.restaurantManagementSystem.UserExperience.order;
...
import com.vangcc19135.RestaurantManagementSystem.databinding.ItemOrderBinding;
...
public class DetailOrderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.binding.tvAmount.setText(drink.getAmount() + "x" + formatter.format(drink.getPrice()) + "VND");
